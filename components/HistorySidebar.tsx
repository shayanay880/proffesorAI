  ...
  return (
    <>
      ...
      <aside 
        ...
        className={`w-80 glass-sidebar text-slate-100 flex flex-col fixed inset-y-0 right-0 z-50
        ...
        <div className="p-6 flex items-center justify-between border-b border-slate-700/50">
          ...
          <button 
            ...
            className="md:hidden p-2 text-slate-400 hover:text-white hover:bg-slate-700/50 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-cyan-400"
          >
        ...
        <div className="p-4 space-y-3">
          <button
            ...
            className="w-full bg-cyan-600 text-white font-bold py-3 px-4 rounded-2xl hover:bg-cyan-500 transition-all flex items-center justify-center gap-2 shadow-lg shadow-cyan-900/20 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-cyan-300"
          >
          ...
          <button
            ...
            className="w-full bg-slate-800 text-slate-200 font-bold py-3 px-4 rounded-2xl hover:bg-slate-700 transition-all flex items-center justify-center gap-2 border border-slate-600 shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-cyan-300"
          >
        ...
        <div className="flex-1 overflow-y-auto px-2 py-4 space-y-1">
          ...
          {conversations.map(convo => (
            <div
              ...
              } focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-cyan-300`}
            >
              ...
              <button
                ...
                className="opacity-0 group-hover:opacity-100 p-2 hover:bg-rose-500/20 text-slate-500 hover:text-rose-400 rounded-xl transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-rose-400"
