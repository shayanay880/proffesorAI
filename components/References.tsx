                ...
                {references.map((ref, index) => (
                    <li key={index} className="flex items-start">
                        ...
                        {(() => {
                            ...
                            const safeTitle = displayTitle || 'Unknown source';
                            ...
                            return (
                                <div className="text-xs">
                                    <a
                                        ...
                                        title={safeTitle}
                                    >
                                        <bdi dir="ltr" className="bdi-isolate">{safeTitle}</bdi>
                                    </a>
                                    {ref.snippet && (
                                        <p className="text-gray-600 mt-0.5 leading-snug">{ref.snippet}</p>
                                    )}
                                </div>
                            );
                        })()}
