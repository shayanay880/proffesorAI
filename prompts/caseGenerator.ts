...
- Every stage must include a checkpoint question and keep the rationale in reveal/teaching (do NOT bury answers in the narrative).
- Provide 2-4 options when possible; expectedAnswer should match one option and stay hidden until reveal.
...
- If interactive=true, keep each storyline item concise with a prompt then a reveal; require a checkpoint question before any reveal. If false, narratives can be fuller but should still include a brief checkpoint question + separate rationale.
